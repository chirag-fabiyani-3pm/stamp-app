...
export function ModernCatalogContent() {
  ...
  const [activeSection, setActiveSection] = useState<'countries' | 'featured' | 'recent'>('countries')
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100">
      ...
      <header className="relative overflow-hidden">
          {/* Hero Section */}
          <div className="relative h-[400px] sm:h-[500px] md:h-[600px] bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900">
            {/* Video Background */}
            <video
              autoPlay
              loop
              ...
              <div className="max-w-3xl">                
                ...
                <div className="max-w-xl mb-8">
                  <div className="relative">
                    <Input 
                      type="text" 
                      placeholder="Search by country, year, color, or catalog number..." 
                      className="py-6 pl-12 pr-6 rounded-full bg-white/10 backdrop-blur-sm border-white/30 text-white placeholder:text-gray-300"
                      value={searchTerm}
          ...
          <>
            ...
            {activeSection === 'featured' && (
              <section className="mb-12 md:mb-16">
                <div className="text-center mb-8 md:mb-12">
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">Featured Collections</h2>
                  <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    Curated stories showcasing stamps that have earned their place in philatelic history through exceptional quality and collector approval.
                  </p>
                </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl bg-white shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:scale-[1.02] dark:bg-gray-800 dark:border-gray-700">
                        <div className={cn(
                          ...
                          <div className="absolute top-4 left-4">
                            <Badge className="bg-primary text-white dark:text-amber-400">
                              {story.category}
                            </Badge>
                          </div>
                          ...
                          <div className="absolute bottom-4 left-4 right-4">
                            ...
                            <p className="text-gray-200 text-sm mb-2">{story.subtitle}</p>
                            <div className="flex items-center justify-between">
                              <span className="text-gray-300 text-xs">{story.readTime}</span>
                              <BookmarkPlus className="w-4 h-4 text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity" />
                            </div>
                          </div>
                        </div>
                        ...
                        {index === 0 && (
                          <div className="p-4 md:p-6">
                            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{story.excerpt}</p>
                            <Button className="mt-4 bg-primary hover:bg-primary/90 text-white dark:text-amber-400">
                              Read Collection Story
            ...
            {activeSection === 'recent' && (
              <section>
                <div className="text-center mb-8 md:mb-12">
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">Recent Additions</h2>
                  <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    The latest stamps to earn approval in our collection, featuring newly authenticated specimens and fresh acquisitions.
                  </p>
                </div>
                
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8 text-center">
                  <Camera className="w-12 h-12 md:w-16 md:h-16 text-gray-400 mx-auto mb-4" />
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">New Approvals Coming Soon</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                    Our team is currently evaluating new specimens for approval. Check back soon for the latest additions to our premium catalog.
                  </p>
                </div>
              </section>
            )}
