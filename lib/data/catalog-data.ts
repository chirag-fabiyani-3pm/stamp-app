...
export const generateColorsData = async (stampCode: string, denomination: string): Promise<ColorOption[]> => {
  ...
  await new Promise(resolve => setTimeout(resolve, 300))
  return [
    { code: 'Blu', name: 'Royal Blue', hexColor: '#1e40af', totalStamps: 25, stampImageUrl: '/images/stamps/stamp.png', popularity: 9, description: 'The distinguished blue of royal heritage' },
    { code: 'R', name: 'Carmine Red', hexColor: '#dc2626', totalStamps: 20, stampImageUrl: '/images/stamps/stamp.png', popularity: 8, description: 'A bold red that commands approval' },
    { code: 'Gr', name: 'Emerald Green', hexColor: '#059669', totalStamps: 18, stampImageUrl: '/images/stamps/stamp.png', popularity: 7, description: 'The rich green of precious emeralds' },
    { code: 'Pur', name: 'Imperial Purple', hexColor: '#7c3aed', totalStamps: 15, stampImageUrl: '/images/stamps/stamp.png', popularity: 6, description: 'The purple of nobility and prestige' },
    { code: 'Br', name: 'Sepia Brown', hexColor: '#92400e', totalStamps: 12, stampImageUrl: '/images/stamps/stamp.png', popularity: 5, description: 'Warm brown tones of vintage excellence' },
    { code: 'Blk', name: 'Jet Black', hexColor: '#1f2937', totalStamps: 10, stampImageUrl: '/images/stamps/stamp.png', popularity: 4, description: 'The profound depth of classic black' },
    { code: 'Yel', name: 'Golden Yellow', hexColor: '#f59e0b', totalStamps: 8, stampImageUrl: '/images/stamps/stamp.png', popularity: 3, description: 'Bright as sunshine, valuable as gold' }
  ]
}
...
export const generateStampsForAdditionalCategory = async (baseStampCode: string, categoryType: string, categoryCode: string): Promise<StampData[]> => {
  ...
  for (let i = 1; i <= count; i++) {
    ...
    stamps.push({
      ...
      marketValue: Math.floor(finalPrice),
